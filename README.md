data and scripts for Tarshish & Romps (2022). 
...
<ul>
  ...
  <li>LES</li>
    <ul>
      ...
      <li> reisner_case: simulations of the Reisner et al. (2018) source with and without moisture. </li>
    </ul>    
  <li>Reanalysis </li>
    <ul>
...
Tarshish, N. and Romps, D. (2022). Latent heating is required for firestorm plumes to reach the stratosphere. JGR: Atmospheres, submitted.
